...
vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/DHU-project/simulation/src/4links/router_rtl/mixed_width_ram_comp.vhd
vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/DHU-project/simulation/src/4links/router_rtl/mixed_width_ram_top_v2.vhd
...
vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/DHU-project/simulation/src/4links/router_rtl/routing_table_ram.vhd
vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/DHU-project/simulation/src/4links/router_rtl/router_routing_table_top_v2.vhd
...
vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/DHU-project/simulation/src/4links/router_rtl/router_rt_arbiter.vhd
vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/DHU-project/simulation/src/4links/router_rtl/router_rt_arbiter_fifo_priority.vhd
...
vcom -work work -2008 -quiet $DUT/DHU-project/SpW_router/multi-port_Router/src/router_top_level_RTG4.vhd
#vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/SpW_router/reg_bank_inf_asym2.vhd   -----for microchip fpga no need to reset mem
vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/DHU-project/simulation/src/4links/spw_controller/asym_fifo/reg_bank_inf_asym2.vhd
vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/SpW_router/asym_FIFO.vhd 
vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/DHU-project/SpW_router/multi-port_Router/src/router_fifo_spwctrl_16bit_v2.vhd
vcom -work work -2008 -quiet -nocoverfec -cover sbcf3 $DUT/DHU-project/SpW_router/multi-port_Router/src/router_fifo_ctrl_top_v3.vhd
