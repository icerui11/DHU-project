...
# set the working directory, do $DUT/DHU-project/SpW_router/multi-port_Router/modelsim/script/router_multiport.do
# set lib_exists [file exists work]
# if $lib_exists==1 {vdel -all -lib work}
# vlib work
# Check if the 'work' directory exists and forcefully delete it and all its contents
if {[file exists work]} {
    file delete -force work
}

# Create a new, empty 'work' library
vlib work
...
#router library
do $DUT/DHU-project/SpW_router/multi-port_Router/modelsim/script/SpW_all_library.do
do $DUT/DHU-project/SpW_router/multi-port_Router/modelsim/script/ip_core_spw.do
do $DUT/DHU-project/SpW_router/multi-port_Router/modelsim/script/ip_core_rmap.do
do $DUT/DHU-project/SpW_router/multi-port_Router/modelsim/script/ip_core_router.do
do $DUT/DHU-project/SpW_router/multi-port_Router/modelsim/script/ip_core_system.do
#testbench for DUT_16bitInput
vcom -work work -2008 -explicit $DUT/DHU-project/SpW_router/multi-port_Router/tb/router_top_level_RTG4_tb.vhd
#start the simulate
vsim -t 1ps work.router_top_level_RTG4_tb -voptargs=+acc=bcglnprst+router_top_level_RTG4_tb
onbreak {resume}
run -all