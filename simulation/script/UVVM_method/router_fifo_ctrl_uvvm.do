...
#UVVM library
do $DUT/UVVM-master/script/compile_all.do $DUT/UVVM-master/script $DUT/SpW_router/spw_router_sim
#router library
...
vcom -2008 -work work -quiet $DUT/DHU-project/simulation/tb/router_fifo_ctrl_top_tb_uvvm.vhd
vsim -coverage work.router_fifo_ctrl_top_tb_uvvm -vopt -t 1ns -voptargs="+acc"
